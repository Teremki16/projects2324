...
let cards = [
    ...
    {
        name:"драники",
        img:"https://www.google.com/url?sa=i&url=https%3A%2F%2Fmenunedeli.ru%2Frecipe%2Fluchshie-kartofelnye-draniki%2F&psig=AOvVaw0wWq8TOETt-fYRL_gPZMgD&ust=1716203472417000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCMCF46bKmYYDFQAAAAAdAAAAABAE",
        id: 12
    },
    {
        name:"",
...
function startTime() {
    setInterval(function () {
        ...
        if (time <= 0) {
            ...
            setTimeout(() => window.open("../quiz2/task.html"));
