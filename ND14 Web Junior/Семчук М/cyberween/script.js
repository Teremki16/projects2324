...
console.log(`First house gave ${house2} candies`)

let house3 = +prompt("Third house gave")

console.log(`First house gave ${house3} candies`)
...
if(house3 < house1 && house2 > house3){
    console.log("Третій жмот")
}

console.log(`Податками забрал ${Math.floor(summ * 0.13)}`)
