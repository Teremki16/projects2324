...
void createLevel() {
  ...
  if (numLevel == 1)drawBricks(Block_level_3);
  if (numLevel == 1)drawBricks(Block_level_4);
  if (numLevel == 1)drawBricks(Block_level_5);
  if (numLevel == 1)drawBricks(Block_level_6);
  if (numLevel == 1)drawBricks(Block_level_7);
