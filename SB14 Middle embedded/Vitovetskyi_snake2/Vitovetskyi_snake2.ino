#include <GameBoy.h> // створив бібліотеку
GameBoy gb; 

bool state = true; // 

int x = 1, y = 0; // змінна для того, щоб задати початкові коорденати х та y
int dirX, dirY;

int snakeX[30]; // створив масив для змійки координат х
int snakeY[30];
