...
let apiKey = "659981a17d40f22bd49a8d4d"
let url = "https://anyakolega-2743.restdb.io/rest/products"
...
document.querySelector("form").addEventListener("submit", function(event){
    ...
    let data = { 
        ...
        description:   event.target["desciption"].value,
        author_id: 1
};
event.target.reset()
...
xhrA.open("POST", "https://anyakolega-2743.restdb.io/rest/products");
